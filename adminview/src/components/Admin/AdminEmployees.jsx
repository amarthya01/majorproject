...
export function AdminEmployees() {
    ...
    const [employees, setEmployees] = useState([
        { id: "EMP001", name: "John Doe", role: "Senior Developer", team: "Engineering", status: "Active", attendance: "Present", clockIn: "09:15 AM" },
        { id: "EMP002", name: "Jane Smith", role: "Product Manager", team: "Product", status: "On Leave", attendance: "Absent" },
        { id: "EMP003", name: "Bob Johnson", role: "Designer", team: "Design", status: "Active", attendance: "Present", clockIn: "09:15 AM" },
        { id: "EMP004", name: "Alice Brown", role: "HR Specialist", team: "People", status: "Inactive", attendance: "Absent" },
        { id: "EMP005", name: "Charlie Wilson", role: "Backend Developer", team: "Engineering", status: "Active", attendance: "Present", clockIn: "09:00 AM" },
    ]);
    ...
    const filteredEmployees = useMemo(() => {
        return employees.filter(emp => {
            ...
            const matchesDepartment = departmentFilter === "All" || emp.team === departmentFilter;
    ...
    const handleAddEmployee = () => {
        ...
        setNewEmployee({ name: "", role: "", team: "Engineering", status: "Active" });
        setErrors({});
    ...
    return (
        <AdminLayout title="Employees" description="Manage personnel and view attendance records.">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                    {["All", "Active", "On Leave"].map(status => (
                        <button
                            ...
                            className={`px-3 py-1 text-xs uppercase tracking-wider font-medium transition-colors ${statusFilter === status
                    ...
                    <tbody>
                        {filteredEmployees.map((emp) => (
                            ...
                            >
                                ...
                                <td className="py-4 font-mono text-xs text-gray-500">{emp.id}</td>
                                <td className="py-4 text-sm text-gray-600">{emp.role}</td>
                                <td className="py-4 text-sm text-gray-600">{emp.team}</td>
                                <td className="py-4">
                                    <Badge variant={emp.attendance === "Present" ? "success" : emp.attendance === "Absent" ? "error" : "warning"}>
                                        {emp.attendance}
                                    </Badge>
                                </td>
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="mb-12">
                                ...
                                <h2 className="text-3xl font-serif mb-2">{selectedEmployee.name}</h2>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="p-4 bg-gray-50 rounded-sm text-center">
                                        <div className="text-xl font-mono font-medium mb-1">92%</div>
                                        <div className="text-[10px] text-gray-400 uppercase tracking-widest">Attendance</div>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-sm text-center">
                                        <div className="text-xl font-mono font-medium mb-1">09:05</div>
                                        <div className="text-[10px] text-gray-400 uppercase tracking-widest">Avg In</div>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-sm text-center">
                                        <div className="text-xl font-mono font-medium mb-1">4</div>
                                        <div className="text-[10px] text-gray-400 uppercase tracking-widest">Leaves</div>
                                    </div>
                                </div>

                                {/* Recent Attendance */}
                                <div>
                                    <h3 className="text-sm font-medium text-gray-900 mb-4 font-serif">Recent History</h3>
                                    <div className="space-y-3">
                                        {[1, 2, 3].map((i) => (
                                            <div key={i} className="flex items-center justify-between text-sm py-2 border-b border-gray-50">
                                                ...
                                                <span className="font-mono text-gray-400">09:00 - 17:00</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
