...
import { LayoutDashboard, Users, CalendarDays, Bell, CalendarClock, Settings, LogOut, Menu, X } from "lucide-react";
        ...
        <>
            <div>
                <div className="mb-16 px-3 flex items-center gap-2">
                    {/* Logo Placeholder - Editorial Style */}
                    <div className="h-8 w-8 bg-black rounded-full" />
                    <span className="text-xl font-serif font-bold tracking-tight">LuxeHR</span>
                </div>
            ...
            <div className="space-y-2 text-sm text-gray-400 px-3">
                <button className="flex items-center gap-3 w-full text-left hover:text-black transition-colors py-2">
            ...
            <main className="flex-1 py-6 px-4 sm:py-8 sm:px-6 lg:py-12 lg:px-12 lg:ml-64">
                <header className="mb-8 lg:mb-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="pl-12 lg:pl-0">
                        <h1 className="text-3xl sm:text-4xl font-serif leading-none mb-2 sm:mb-3 tracking-tight">{title}</h1>
                        {description && (
