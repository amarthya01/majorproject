...
export default function Dashboard() {
    ...
    const [schedule, setSchedule] = useState([
        { id: 1, time: '9:00 AM', title: 'Team Standup', location: 'Conference Room A' },
        { id: 2, time: '11:30 AM', title: 'Client Call', location: 'Zoom' },
        { id: 3, time: '3:00 PM', title: '1:1 with Manager', location: 'Office' }
    ]);

    const [notifications, setNotifications] = useState([
        { id: 1, text: 'Company picnic this Friday!', time: '2 hours ago', type: 'primary' },
        { id: 2, text: 'Leave request approved', time: '5 hours ago', type: 'success' },
        { id: 3, text: 'Submit Q1 review by March 1', time: '1 day ago', type: 'warning' }
    ]);

    // Mock Data
    const stats = [
        { label: 'Attendance Rate', value: '92', suffix: '%', trend: 3, trendLabel: 'vs last month' },
        { label: 'Avg Clock-in', value: '9:15', suffix: ' AM', trend: 0, trendLabel: 'On time' },
        { label: 'Avg Clock-out', value: '6:30', suffix: ' PM', trend: 0, trendLabel: 'On time' },
        { label: 'Leave Balance', value: '12', suffix: ' Days', trend: 0, trendLabel: 'Remaining' },
    ];
            ...
            <main className="pt-20 sm:pt-24 px-4 sm:px-6 lg:px-12 max-w-[1440px] mx-auto">
                ...
                >
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                        <div>
                            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold mb-2 dark:text-white">Good morning, John</h1>
                            <p className="text-gray-400 font-sans text-sm sm:text-base">Tuesday, February 12, 2024</p>
                        </div>
                        ...
                        >
                            <div className="relative z-10 flex items-center gap-4">
                                <div className="text-left">
                                    ...
                                    <p className="text-lg sm:text-xl font-serif">Mark Attendance</p>
                                </div>
